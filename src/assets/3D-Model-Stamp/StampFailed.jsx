...
export default function StampFailed({ isAction, actionAnimations, animationTimeCheck }) {
    const group = useRef();
    const gltf = useGLTF('/stamp/stampanimation_red.gltf');
