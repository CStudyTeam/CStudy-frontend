...
import { getContest, getContestMyRanking, getContestProblem, getContestRanking } from 'api/contest';
...
export const useMixContestDetailAllData = ({ categoryTitle, status, page, query, contestId }: MixQueryProps) => {
    const [
        problemListResult,
