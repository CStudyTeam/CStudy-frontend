                ...
                <Styled.Wrapper>
                    ...
                    <Styled.ContentsItem>
                        <Styled.ContentsTexts>
                            <Styled.ContentsTextsTitle>어렵게 생각하는 CS지식을 문의하세요!</Styled.ContentsTextsTitle>
                            <br />
                            ...
                            <StyleLink to="/board" className="xl navy style">
                                게시판 보러 가기
                            </StyleLink>
                        </Styled.ContentsTexts>
                    </Styled.ContentsItem>
                ...
                <Styled.Wrapper>
                    <Styled.ContentsItem>
                        <Styled.ContentsTexts>
                            ...
                            <StyleLink to="/contest" className="xl navy style">
                                대회 보러 가기
                            </StyleLink>
                        </Styled.ContentsTexts>
                    </Styled.ContentsItem>
                ...
                <Styled.Wrapper>
                    ...
                    <Styled.ContentsItem>
                        <Styled.ContentsTexts>
                            ...
                            <StyleLink to="/membersranks" className="xl navy style">
                                랭킹 확인 하기
                            </StyleLink>
                        </Styled.ContentsTexts>
                    </Styled.ContentsItem>
